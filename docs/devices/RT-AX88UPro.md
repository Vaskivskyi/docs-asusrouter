...
|[Ports](/features/ports.md)|:green_heart: Full|`lan_speed` attributes:<li>`lan_{x}`, `x=[1,4]`</li><li>up to `1000 Mb/s`</li><li>`lan_5`</li><li>up to `2500 Mb/s`</li>`wan_speed` attributes:<li>`wan_0`</li><li>up to `2500 Mb/s`</li>|<li>LAN aggregation</li><li>WAN aggregation</li>|
