...
|[CPU](/features/cpu.md)|:green_heart: Full|`cpu` attributes:<br /><li>`core_{x}`, `x=[1,4]`</li>|1.8 GHz quad-core processor<li>`BCM490x - Cortex A53 ARMv8 revision 0`</li>|
