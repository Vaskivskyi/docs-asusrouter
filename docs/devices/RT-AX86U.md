...
|---|---|
|<img src="https://asusrouter.vaskivskyi.com/devices/RT-AX86U.png" width="300">|<b>Stock:</b><li>`386_46061`</li><li>`386_48260`</li><b>Merlin:</b><li>`386.7_2`</li>|
...
|[CPU](/features/cpu.md)|:green_heart: Full|`sensor.{device}_cpu` attributes:<br /><li>`core_{x}`, `x=[1,4]`</li>|1.8 GHz quad-core processor|
