---
title: "Asus RT-AX86U control from Home Assistant"
description: "Integrate your RT-AX86U into Home Assistant with AsusRouter"
---
<!-- !!! -->
...
|---|---|
|<img src="https://asusrouter.vaskivskyi.com/devices/RT-AX86U.png" width="300">|<b>Stock:</b><li>`386.46061`</li><li>`386.48260`</li><li>`386.49447`</li><li>`388.22525`</li><b>Merlin:</b><li>`386.7_2`</li><li>`388.4_0`</li>|
...
|[CPU](/features/cpu.md)|:green_heart: Full|`cpu` attributes:<br /><li>`core_{x}`, `x=[1,4]`</li>|1.8 GHz quad-core processor|
