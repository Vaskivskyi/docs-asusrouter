...
description: "Integrate your TUF-AX3000 V2 into Home Assistant with AsusRouter"
---
<!-- !!! -->
...
|---|---|
|<img src="https://asusrouter.vaskivskyi.com/devices/TUF-AX3000V2.png" width="300">|<b>Stock:</b><li>`388.23785`</li><b>Merlin:</b><li>` `</li>|
|<li><a href="https://www.asus.com/networking-iot-servers/wifi-routers/asus-gaming-routers/tuf-gaming-ax3000-v2/" rel="nofollow" target="_blank">Official webpage</a></li><li><a href="https://amzn.to/3QzzD4C" rel="nofollow sponsored" target="_blank">Buy it on Amazon [^amazon]</a></li>|<li>:green_heart: Tested to work with AsusRouter</li><li><a href="https://github.com/Vaskivskyi/ha-asusrouter/issues/new/choose" rel="nofollow" target="_blank">Add you report about this device</a></li>|
...
|[Ports](/features/ports.md)|:green_heart: Full|`lan_speed` attributes:<li>`lan_{x}`, `x=[1,4]`</li><li>up to `1000 Mb/s`</li>`wan_speed` attributes:<li>`wan_0`</li><li>up to `2500 Mb/s`[^2gb]</li>|<li>LAN aggregation</li>|
