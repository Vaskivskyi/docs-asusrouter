---
title: "Asus RT-AC87U control from Home Assistant"
description: "Integrate your RT-AC87U into Home Assistant with AsusRouter"
---
<!-- !!! -->
...
|RT-AC87U|Tested / reported firmware|
|---|---|
|<img src="https://asusrouter.vaskivskyi.com/devices/RT-AC87U.png" width="300">|<b>Stock:</b><li>` `</li><b>Merlin:</b><li>`384.13_10`</li>|
|<li><a href="https://amzn.to/3i4sUkE" rel="nofollow sponsored" target="_blank">Buy it on Amazon [^amazon]</a></li>|<li>:green_heart: Tested to work with AsusRouter</li><li><a href="https://github.com/Vaskivskyi/ha-asusrouter/issues/new/choose" rel="nofollow" target="_blank">Add you report about this device</a></li>|
...
|[CPU](/features/cpu.md)|:green_heart: Full|`cpu` attributes:<br /><li>`core_{x}`, `x=[1,2]`</li>|1.0 GHz dual-core processor|
...
|[WLAN](/features/wlan.md)|:green_heart: Full|types:<li>`2.4 GHz`</li><li>`5 GHz`</li>|speed:<li>`<= 600 Mb/s (2.4 GHz)`</li><li>`<= 1734 Mb/s (5 GHz)`</li>|
