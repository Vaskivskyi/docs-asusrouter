---
title: "Asus RT-AC68U control from Home Assistant"
description: "Integrate your RT-AC68U into Home Assistant with AsusRouter"
---
<!-- !!! -->
...
|RT-AC68U|Tested / reported firmware|
|---|---|
|<img src="https://asusrouter.vaskivskyi.com/devices/RT-AC68U.png" width="300">|<b>Stock:</b><li>`3.0.0.4.386_49703`</li><b>Merlin:</b><li>`386.5_2`</li><li>`386.7_0`</li>|
|<li><a href="https://www.asus.com/networking-iot-servers/wifi-routers/asus-wifi-routers/rtac68u/" rel="nofollow" target="_blank">Official webpage</a></li><li><a href="https://amzn.to/3i6dQTE" rel="nofollow sponsored" target="_blank">Buy it on Amazon [^amazon]</a></li>|<li>:green_heart: Tested to work with AsusRouter</li><li><a href="https://github.com/Vaskivskyi/ha-asusrouter/issues/new/choose" rel="nofollow" target="_blank">Add you report about this device</a></li>|
...
|[CPU](/features/cpu.md)|:green_heart: Full|`sensor.{device}_cpu` attributes:<br /><li>`core_{x}`, `x=[1,2]`</li>|1.0 GHz dual-core processor<li>`ARM Cortex A9`</li>|
