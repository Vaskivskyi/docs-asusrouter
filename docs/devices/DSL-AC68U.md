...
|DSL-AC68U|Tested / reported firmware|
|---|---|
|<img src="https://asusrouter.vaskivskyi.com/devices/DSL-AC68U.png" width="300">|<b>Stock:</b><li>`386_47534`</li><b>Merlin:</b><li>`386.4-gnuton2`</li><li>`386.7_2-gnuton1`</li>|
|<li><a href="https://www.asus.com/networking-iot-servers/modem-routers/all-series/dslac68u/" rel="nofollow" target="_blank">Official webpage</a></li><li><a href="https://amzn.to/3Z5k32H" rel="nofollow sponsored" target="_blank">Buy it on Amazon [^amazon]</a></li>|<li>:green_heart: Tested to work with AsusRouter</li><li><a href="https://github.com/Vaskivskyi/ha-asusrouter/issues/new/choose" rel="nofollow" target="_blank">Add you report about this device</a></li>|
...
|[CPU](/features/cpu.md)|:green_heart: Full|`sensor.{device}_cpu` attributes:<br /><li>`core_1`</li>|single-core processor|
...
|[Ports](/features/ports.md)|:green_heart: Full|`lan_speed` attributes:<li>`lan_{x}`, `x=[1,4]`</li><li>up to `1000 Mb/s`</li>`wan_speed` attributes:<li>`wan_0`</li><li>up to `100 Mb/s`</li>||
...
|[WLAN](/features/wlan.md)|:green_heart: Full|types:<li>`2.4 GHz`</li><li>`5 GHz`</li>|speed:<li>`<= 600 Mb/s (2.4 GHz)`</li><li>`<= 1300 Mb/s (5 GHz)`</li>|
