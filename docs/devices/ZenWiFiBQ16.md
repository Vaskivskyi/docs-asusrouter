---
title: "Asus ZenWiFi BQ16 control from Home Assistant"
description: "Integrate your ZenWiFi BQ16 into Home Assistant with AsusRouter"
---
<!-- !!! -->
...
|ZenWiFi BQ16|Tested / reported firmware|
|---|---|
|<img src="https://asusrouter.vaskivskyi.com/devices/ZenWiFiBQ16.png" width="300">|<b>Stock:</b><li>` `</li><b>Merlin:</b><li>` `</li>|
|<li><a href="https://www.asus.com/networking-iot-servers/whole-home-mesh-wifi-system/zenwifi-wifi-systems/asus-zenwifi-bq16/" rel="nofollow" target="_blank">Official webpage</a></li><li><a href="https://amzn.to/4bgVvdo" rel="nofollow sponsored" target="_blank">Buy it on Amazon [^amazon]</a></li>|<li>:yellow_heart: This device has not been tested yet, but should work with AsusRouter</li><li><a href="https://github.com/Vaskivskyi/ha-asusrouter/issues/new/choose" rel="nofollow" target="_blank">Add you report about this device</a></li>|
...
|[WLAN](/features/wlan.md)|:green_heart: Full|types:<li>`2.4 GHz`</li><li>`5 GHz`</li><li>`5 GHz-2`</li><li>`6 GHz`</li>|speed:<li>`<= 1376 Mb/s (2.4 GHz)`</li><li>`<= 5764 Mb/s (5 GHz)`</li><li>`<= 5764 Mb/s (5 GHz-2)`</li><li>`<= 11529 Mb/s (6 GHz)`</li>|
