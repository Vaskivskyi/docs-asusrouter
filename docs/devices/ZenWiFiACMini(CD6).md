...
|[CPU](/features/cpu.md)|:green_heart: Full|`cpu` attributes:<br /><li>`core_1`</li>|775 MHz single-core processor|
...
|[Ports](/features/ports.md)|:green_heart: Full|`lan_speed` attributes:<li>`lan_{x}`, `x=[1,3]`</li><li>up to `1000 Mb/s`</li>`wan_speed` attributes:<li>`wan_0`</li><li>up to `1000 Mb/s`</li>|<li>LAN aggregation</li>|
...
|[WLAN](/features/wlan.md)|:green_heart: Full|types:<li>`2.4 GHz`</li><li>`5 GHz`</li>|speed:<li>`<= 600 Mb/s (2.4 GHz)`</li><li>`<= 867 Mb/s (5 GHz)`</li>|
