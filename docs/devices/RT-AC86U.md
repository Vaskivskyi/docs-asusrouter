---
title: "Asus RT-AC86U control from Home Assistant"
description: "Integrate your RT-AC86U into Home Assistant with AsusRouter"
---
<!-- !!! -->
...
|RT-AC86U|Tested / reported firmware|
|---|---|
|<img src="https://asusrouter.vaskivskyi.com/devices/RT-AC86U.png" width="300">|<b>Stock:</b><li>`386.48260`</li><li>`386.49709`</li><b>Merlin:</b><li>`386.7_0`</li><li>`386.7_2`</li><li>`386.9_0`</li>|
|<li><a href="https://www.asus.com/networking-iot-servers/wifi-routers/asus-wifi-routers/rt-ac86u/" rel="nofollow" target="_blank">Official webpage</a></li><li><a href="https://amzn.to/3CbRarK" rel="nofollow sponsored" target="_blank">Buy it on Amazon [^amazon]</a></li>|<li>:green_heart: Tested to work with AsusRouter</li><li><a href="https://github.com/Vaskivskyi/ha-asusrouter/issues/new/choose" rel="nofollow" target="_blank">Add you report about this device</a></li>|
...
|[WLAN](/features/wlan.md)|:green_heart: Full|types:<li>`2.4 GHz`</li><li>`5 GHz`</li>|speed:<li>`<= 750 Mb/s (2.4 GHz)`</li><li>`<= 2167 Mb/s (5 GHz)`</li>|
